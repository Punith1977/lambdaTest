...
test("first Scenario test", async () => {
    const capabilities = {
        ...
        'LT:Options': {
            ...
            'user': 'punithkrishnan.m',
            'accessKey': 's4U44owsup6c7mVFiLOaINNC3ghEjS0ExfpozuClmevSURJ6Mp',
            'network': true,
            'video': true,
            'console': true
        }
...
test("Third Scenario test", async () => {
    ...
    await page.locator('//input[@id="inputAddress2"]').fill('dubai main road')
